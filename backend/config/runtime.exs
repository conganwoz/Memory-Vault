...
#
#     PHX_SERVER=true bin/kindred_backend start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :kindred_backend, KindredWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  # Directory where uploaded images are stored and served from. Defaults to
  # `priv/static/uploads` inside the release root (stable across versions and
  # mounted as a volume in Docker).
  config :kindred_backend,
         :uploads_dir,
         System.get_env("UPLOADS_DIR", Path.join(:code.root_dir(), "priv/static/uploads"))
  ...
  config :kindred_backend, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
